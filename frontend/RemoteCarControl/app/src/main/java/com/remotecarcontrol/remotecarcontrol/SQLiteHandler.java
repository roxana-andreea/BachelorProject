...
public class SQLiteHandler extends SQLiteOpenHelper{
    ...
    private static final String KEY_CREATED_AT = "_created";
     ...
     * */
    public void addUser(String name, String login, String uid, String created_at) {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("_created", cursor.getString(4));
        }
        cursor.close();
        db.close();
        // return user
